    ...
    <div className="d-flex h-100 text-center text-bg-dark">
      ...
      <div className="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main className="px-3">
          ...
          <p className="lead">
            This Online Recipe App is a web-based platform that allows users to
            register, log in, manage their profile, and create, view, edit, and
            delete recipes. The app also features recipe categorization and
            search functionality, ensuring a user-friendly experience for
            organizing and discovering recipes.
          </p>
          <p className="lead">
            <a
              href="#"
